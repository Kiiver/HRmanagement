...
<html>
  ...
  <body>
    ...
    <%
     	...
     	//获取表单信息
     	t_hr_bmxx.setBM_ID(Integer.parseInt(request.getParameter("ID")));
	    ...
	    boolean result = op.addT_HR_BMXX(t_hr_bmxx);
	    out.println("<br/><br/><br/><br/><br/><br/>");
	    if(result){
			out.println("<H2><center>记录添加成功!</center></H2><br>"); 
	      	out.println("<H3><center>2秒钟后，自动跳转到部门信息页面！</center></H3>");
	      	...
	      	response.setHeader("refresh","2;url=T_HR_BMXX_add.jsp");
	    }
     %>
   	</div>
  </body>
